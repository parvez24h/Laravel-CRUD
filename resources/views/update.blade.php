            ...
            <div class="card-body">
                <form method="POST" action="/{{$item->id}}/update" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" class="form-control" id="description" name="description">{{ old('description', $item->description) }}</textarea>
                    ...
                    <div class="d-grid col-12 mx-auto mt-4">
                        <button class="btn btn-outline-secondary fs-5 fw-medium" type="submit">Update Item</button>
                    </div>
                </form>
            </div>
        </div>    
